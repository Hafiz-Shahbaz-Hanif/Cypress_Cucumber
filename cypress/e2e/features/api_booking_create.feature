...
Feature: Creating bookings with varied data (restful-booker)
  As an API consumer
  I want the create + read round-trip proven across many inputs

  Scenario Outline: Create "<firstname> <lastname>" priced <price> and read it back
    ...
    Examples:
      ...
      | Jean      | OBrien     | 5000  | true    | 2026-09-01 | 2026-12-31 | Long stay      |
      ...
      | Fatima    | Zahra      | 610   | true    | 2026-11-03 | 2026-11-10 | Connecting     |
